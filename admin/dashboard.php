...
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-lg-3 col-xs-6">
        <?php 
            $sql = "SELECT COUNT(ID_Resitrado) AS registros FROM registrados";
        ...
        <div class="col-lg-3 col-xs-6">
        <?php 
            $sql = "SELECT COUNT(ID_Resitrado) AS registros FROM registrados WHERE pagado = 1";
            $resultado = $conn->query($sql);
            $registrados = $resultado->fetch_assoc();
        ...
        ?>
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="lista-registrados.php" class="small-box-footer">
              Más Informacíon <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
        <?php 
            $sql = "SELECT COUNT(ID_Resitrado) AS registros FROM registrados WHERE pagado = 0";
            $resultado = $conn->query($sql);
            $registrados = $resultado->fetch_assoc();
