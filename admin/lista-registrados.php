                            ...
                            <tbody>
                                ...
                                while ($registrado = $resultado->fetch_assoc()) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="editar-registro.php?id=<?php echo $registrado['ID_Resitrado']; ?>" class="btn bg-orange btn-flat margin">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <a href="" data-id="<?php echo $registrado['ID_Resitrado']; ?>" data-tipo="registrado" class="btn bg-maroon bnt-flat margin borrar_registro">
