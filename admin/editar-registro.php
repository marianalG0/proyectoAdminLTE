...
$id = $_GET['id'];
//SE COMENTO TEMPORALMENTE
// if (filter_has_var($id, FILTER_VALIDATE_INT)) {
//     die("Error");
// }
        ...
        <div class="col-md-8">
            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <?php
                            $sql = "SELECT * FROM registrados WHERE ID_Resitrado = $id ";
                        ...
                        <form class="editar-registrado" role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-registrado.php">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $registrado['nombre_registrado'] ?>" class="form-control" id="nombre" name="nombre" placeholder="Nombre">
                                </div>
                                <div class="form-group">
                                    <label for="apellido">Apellido:</label>
                                    <input type="text" value="<?php echo $registrado['apellido_registrado'] ?>" class="form-control" id="apellido" name="apellido" placeholder="Apellido">
                                </div>
                                <div class="form-group">
                                    <label for="email">Email:</label>
                                    <input type="email" value="<?php echo $registrado['email_registrado'] ?>" class="form-control" id="email" name="email" placeholder="Email">
                                </div>
                                <?php 
                            ...
                            <div class="box-footer">
                                ...
                                <input type="hidden" name="total_descuento" id="total_descuento" value="total-descuento">
                                <input type="hidden" name="registro" value="actualizar">
                                <input type="hidden" name="id_registro" value="<?php echo $registrado['ID_Resitrado']; ?>">
